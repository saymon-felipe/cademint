<template>
    <div class="leave-group-wrapper">
        <div class="leave-group-modal">
            <p class="font-size-2-bold">Tem certeza que deseja sair do grupo?</p>
            <div class="buttons">
                <button class="confirm" v-on:click="leaveGroup()">Sim, sair</button>
...
export default {
    ...
    methods: {
        showModal: function () {
            let container = $(".leave-group-modal");
            let overlay = $(".leave-group-wrapper .overlay");
        ...
        leaveGroup: function () { // Função apaga o grupo solicitado.
            let self = this;
            ...
            api.post("/projects/exclude_user", data, {
                headers: {
                    Authorization: jwt
                }
            })
